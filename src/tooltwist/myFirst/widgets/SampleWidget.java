package tooltwist.myFirst.widgets;
...
//import tooltwist.myFirst.productionHelpers.SampleProductionHelper;
 ...
 * sample
 */
public class SampleWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "sample_preview.html";
	private static final String SNIPPET_DESIGN = "sample_design.html";
	private static final String SNIPPET_PRODUCTION = "sample_production.jsp";
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "sample_cssHeader.css")),
			};
...
//				new JavascriptCodeInserter(instance.miscellaneousFilePath(generator, "sample_jsHeader.js")),
...
//				codeInserterList.add(WbdProductionHelper.codeInserter(instance, SampleProductionHelper.class.getName(), productionHelperParams));
//				codeInserterList.add(new PageImportCodeInserter(SampleProductionHelper.class.getName()));
			}
		}
